...
{
    return (*st.rbegin()).F; /** highest freq **/

    /** if the query is the value with highest freq , then return (*st.rbegin()).S
    Note that there can be multiple answers in this case
    **/
}
